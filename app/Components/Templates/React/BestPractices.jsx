...
const BestPractices = ({ title, subtitle, features = [] }) => {
    return (
        <div className="template-best-practices min-h-screen">
            {/* Hero Section */}
                ...
                <div className="container mx-auto px-4">
                    <div className="text-center max-w-4xl mx-auto">
                        ...
                        <p className="text-xl md:text-2xl text-gray-400 mb-8">
                            {subtitle || 'Guidelines and standards'}
                        </p>
