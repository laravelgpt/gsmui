...
@section('title', 'Startup Template')

@section('content')
<div class="template-startup min-h-screen" x-data="templateConfig()">
    <!-- Hero Section -->
        ...
        <div class="container mx-auto px-4">
            <div class="text-center max-w-4xl mx-auto">
                ...
                <p class="text-xl md:text-2xl text-gray-400 mb-8">
                    {{ $subtitle ?? 'Modern startup landing with hero, features, testimonials' }}
                </p>
